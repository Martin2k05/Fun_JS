...
let valor;
valor=parseInt(prompt('Ingrese un numero entre el 1 y el 3'));
...
let color;
color=parseInt(prompt('Ingrese el 1 para el color azul, 2 para el amarillo y el 3 para el color naranja'));

switch (color) {
    case 1:
        document.writeln('Ingrese Color Azul: ');
        break;
    case 2:
        document.writeln('Ingrese Color Verde: ');
        break;
    case 3:
        document.writeln('Ingrese Color Naranja: ');
        break;
    default:
        document.writeln('Color digitado esta fuera del rango solicitado');
        break;
}